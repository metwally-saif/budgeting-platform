        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-400 md:text-4xl">
              Simple helps you take care of your finances
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-400">
                <svg
              ...
              <p className="text-[15px] text-gray-400">
                Get personalized financial recommendations based on your
                spending habits.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Create and manage budgets dynamically with real-time
                suggestions.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Automatically categorize and analyze your expenses with AI.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-400">
              ...
              <p className="text-[15px] text-gray-400">
                Set financial goals and let AI track your progress toward them.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-400">
              ...
              <p className="text-[15px] text-gray-400">
                Plan ahead with predictions for future expenses based on past
                trends.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Enjoy a seamless user experience with a clean and intuitive
                interface.
              </p>
            </article>
          </div>
